  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4">
      ...
      <Card className={`${getWinRateBgColor(winRate)} border-2 min-w-0 overflow-hidden`}>
        ...
        <p className="text-gray-400 text-xs md:text-sm mb-1">Taxa de Acerto</p>
      ...
      <Card className="bg-bg-card/50 border-white/5 min-w-0 overflow-hidden">
        ...
        <p className="text-gray-400 text-xs md:text-sm mb-1">Total Operações</p>
      ...
      <Card className="bg-bg-card/50 border-white/5 min-w-0 overflow-hidden">
        ...
        <p className="text-gray-400 text-xs md:text-sm mb-1">Vitórias</p>
      ...
      <Card className="bg-bg-card/50 border-white/5 min-w-0 overflow-hidden">
        ...
        <p className="text-gray-400 text-xs md:text-sm mb-1">Perdas</p>
